...
def _judge_quality(cfg, paper, deep):
    ...
    prompt = f"""당신은 깐깐한 기술 뉴스레터 편집장입니다. 아래 초안을 '인사이트 품질' 기준으로 냉정하게 평가하세요.
독자는 SK하이닉스 실무자이고, 아침에 시간을 들여 읽을 만한 '배울 점'이 있어야 합니다.
...
- clarity: 비전공자가 차근차근 따라가며 이해할 수 있는가?

아래 JSON으로만 답하세요:
{{"scores":{{"specificity":N,"insight":N,"no_fluff":N,"clarity":N}},
